export default function Lab1() {
  return (
    <div id="wd-lab1">
      <h1>Ayan Chandra - CS5610 Summer 2 2025</h1>
      <h2>Lab 1</h2>
      <h3>HTML Examples</h3>
      <div id="wd-h-tag">
        <h4>Heading Tags</h4>
      ...
      <ol id="wd-your-favorite-recipe">
        ...
        <li>Add a small amount of ghee.</li>
        <li>Crack an egg into the pan.</li>
        <li>Cook until the whites are set.</li>
      ...
      <div id="wd-anchors">
        ...
        <br />
        Or visit{" "}
        <a href="https://github.com/ayanchandra2005" id="wd-github">
          my GitHub
        </a>
      </div>
    </div>
